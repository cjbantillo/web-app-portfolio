    ...
    return {
      education: [
        ...
        },
        {
          ...
          description:
            "Explored graphic design and was introduced to web development through HTML, CSS, and JavaScript, which strengthened my passion for software development.",
...
.timeline-item {
  position: relative;
  display: grid;
  grid-template-columns: 1.1rem 6.5rem 1fr;
  column-gap: 0.9rem;
  align-items: start;
}
